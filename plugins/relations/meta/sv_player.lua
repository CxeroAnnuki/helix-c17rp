...
function PLAYER:UpdateRelations(client)
    ...
    for k, v in ents.Iterator() do
        ...
        for k2, v2 in pairs(relations) do
            ...
            local disposition = hook.Run("ModifyNPCDisposition", client, v, k2)
            if ( disposition == nil ) then
                disposition = k2
            end

            v:AddEntityRelationship(client, disposition, ix.config.Get("npcRelationsPriority", 0))
        end
    end
end
